...
import CircularProgressBars from "./circular-progress-bar/CircularProgressBars";
...
const Power = () => {
  ...
  return (
    <>
      <Seo
        title="Digital Marketing Agency for Power Industry | Bangalore | Hyderabad"
        description="Digital marketing agency for power industry in bangalore and hyderabad. Energize your brand's presence with our Power Industry Digital Marketing expertise. "
        name="Company name."
        type="article"
      ...
      <section className="section-top">
        ...
        >
          <img
            ...
            src="assest/photos/b2b/b2b-banner7.png"
            alt="G-Rank"
          />
          <img
            className="img-fluid w-100 desktop-none"
            src="assest/photos/b2b/b2b-banner7-mobile.png"
            alt="G-Rank"
          />
          ...
          <div className="container">
            <div className="row">
              <div className="col-12 col-md-5 col-lg-5 align-self-center">
                <h2 className="b2b-message-h2  b2b-pt">Sustaining </h2>
                <h1 className="b2b-message-div">
                  <span></span>
                  <div class="b2b-message">
                    <div class="word1">Tomorrow's</div>
                    <div class="word2">Future</div>
                    <div class="word3">Upcoming</div>
                  </div>
                </h1>
                <h2 className="b2b-message-h2">Energy Today</h2>
              </div>
              <div className="col-12 col-md-7 col-lg-7">
                <p className="b2b-message-p  b2b-pt">
                  ...
                  digital marketing in the Power domain.
                  <br />
                  <br />
                  We create personalized marketing strategies using your data,
                  market trends, and industry insights to distinguish your brand
