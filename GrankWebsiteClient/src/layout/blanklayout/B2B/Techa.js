...
const Tech = () => {
  ...
  return (
    <>
      <Seo
        title="Digital Marketing Agency for Tech Industries| Bangalore | Hyderabad"
        description="Digital marketing agency for tech industry in bangalore and hyderabad. Empower your tech brand with our Digital Marketing expertise. Explore how we navigate the ever-evolving tech landscape, boost online visibility"
        name="Company name."
        type="article"
      ...
      <section className="section-top">
        ...
        >
          <img
            ...
            src="assest/photos/b2b/b2b-banner3.png"
            alt="G-Rank"
          />
          <img
            className="img-fluid w-100 desktop-none"
            src="assest/photos/b2b/b2b-banner3-mobile.png"
            alt="G-Rank"
          />
            ...
            <div className="row">
              <div className="col-12 col-md-5 col-lg-5 align-self-center">
                ...
                <h1 className="b2b-message-div">
                  ...
                  <div class="b2b-message">
                    <div class="word1">Landscape</div>
                    <div class="word2">Space</div>
                    <div class="word3">Setting</div>
                  </div>
                </h1>
              </div>
              <div className="col-12 col-md-7 col-lg-7">
                <p className="b2b-message-p b2b-pt">
                  ...
                  digital marketing in the Tech domain. <br />
                  <br />
                  We help you identify and implement growth opportunities using
                  proven frameworks and strategies to maximize revenue
                  potential.
                </p>
              </div>
            </div>
          ...
          <div className="container-fluid">
            <div>
              <motion.h2
                ...
                transition={{ duration: 0.6 }}
              >
                Tech Digital Marketing Services
              </motion.h2>
              <Slider {...settings3}>
