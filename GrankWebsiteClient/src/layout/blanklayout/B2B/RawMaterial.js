  ...
  return (
    <>
      <Seo
        ...
        ing Agency for Raw Material Industry | Bangalore | Hyderabad"
        description="Digital marketing agency for raw material industry in bangalore and hyderabad. Refine your presence in the raw material industry with our specialized Digital Marketing solutions. s"
        name="Company name."
        type="article"
      ...
      <section className="section-top">
        ...
        >
          <img
            ...
            src="assest/photos/b2b/b2b-banner8.png"
            alt="G-Rank"
          />
          <img
            className="img-fluid w-100 desktop-none"
            src="assest/photos/b2b/b2b-banner8-mobile.png"
            alt="G-Rank"
          />
            ...
            <div className="row">
              <div className="col-12 col-md-5 col-lg-5 align-self-center">
                ...
                <h1 className="b2b-message-div">
                  ...
                  <div class="b2b-message">
                    <div class="word1">Treasure</div>
                    <div class="word2">Views</div>
                    <div class="word3">Beliefs</div>
                  </div>
                </h1>
              </div>
              <div className="col-12 col-md-7 col-lg-7">
                <p className="b2b-message-p b2b-pt">
                  ...
                  digital marketing in the Raw materials domain.
                  <br />
                  <br />
                  We tailor our digital marketing strategy to meet each client's
                  <br />
                  specific needs, resulting in long-term, trustworthy
                  <br />
                  relationships.
                </p>
              </div>
          ...
          <div className="container-fluid">
            <div>
              <motion.h2
                ...
                transition={{ duration: 0.6 }}
              >
                Raw Materials Digital Marketing Services
              </motion.h2>
              <Slider {...settings3}>
          ...
          <div className="footerimg-div">
            ...
            <div className="footer-div-text">
              <motion.p
                ...
                transition={{ duration: 0.6 }}
              >
                Want to Grow your Raw
                <br /> Materials Business?
              </motion.p>
              <a href="#">
                <motion.p
