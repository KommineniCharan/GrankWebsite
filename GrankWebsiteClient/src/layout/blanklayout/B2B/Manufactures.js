...
const Manufacture = () => {
  ...
  return (
    <>
      <Seo
        title="Digital Marketing Agency for Manufacturing | Bangalore | Hyderabad"
        description="Digital marketing agency for manufacturing industry in bangalore and hyderabad. Elevate your manufacturing brand with precision-crafted Digital Marketing strategies."
        name="Company name."
        type="article"
      ...
      <section className="section-top">
        ...
        >
          <img
            ...
            src="assest/photos/b2b/b2b-banner4.png"
            alt="G-Rank"
          />
          <img
            className="img-fluid w-100 desktop-none"
            src="assest/photos/b2b/b2b-banner4-mobile.png"
            alt="G-Rank"
          />
            ...
            <div className="row">
              ...
              <div className="col-12 col-md-7 col-lg-7">
                <p className="b2b-message-p b2b-pt">
                  ...
                  digital marketing in the Manufacturing domain.
                  <br />
                  <br />
                  We help businesses grow online by analyzing competition,
                  predicting revenue, implementing trustworthy tracking, and
                  providing exceptional strategy, services, reporting, and
                  industry insights.
                </p>
              </div>
            </div>
