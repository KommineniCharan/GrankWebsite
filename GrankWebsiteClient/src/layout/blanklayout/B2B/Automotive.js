...
const Automotive = () => {
  ...
  return (
    <>
      <Seo
        title="Automotive Digital Marketing Agency | Bangalore | Hyderabad"
        description="Automotive digital marketing agency in bangalore and hyderabad. Explore how we rev up your online presence, engage with your audience, and accelerate growth through specialized strategies and campaigns."
        name="Company name."
        type="article"
      ...
      <section className="section-top">
        ...
        >
          <img
            ...
            src="assest/photos/b2b/b2b-banner5.png"
            alt="G-Rank"
          />
          <img
            className="img-fluid w-100 desktop-none"
            src="assest/photos/b2b/b2b-banner5-mobile.png"
            alt="G-Rank"
          />
            ...
            <div className="row">
              <div className="col-12 col-md-5 col-lg-5 align-self-center">
                <h2 className="b2b-message-h2 b2b-pt">
                  Crafting Excellence, Accelerating
                </h2>
                <h1 className="b2b-message-div">
                  <span></span>
                  <div class="b2b-message">
                    <div class="word1">Innovation</div>
                    <div class="word2">Creativity</div>
                    <div class="word3">Ingenuity</div>
                  </div>
                </h1>
              </div>
              <div className="col-12 col-md-7 col-lg-7">
                <p className="b2b-message-p b2b-pt">
                  ...
                  digital marketing in the Automotive domain.
                  <br />
                  <br />
                  We use market analytics, creative content, and social media
                  management to reach customers and boost sales.
                </p>
              </div>
            </div>
          </div>
