            ...
            <div className="row">
              <div className="col-12 col-md-5 col-lg-5 align-self-center">
                ...
                <h1 className="b2b-message-div">
                  ...
                  <div class="b2b-message">
                    <div class="word1">Connectivity</div>
                    <div class="word2">Networking,</div>
                    <div class="word3">Interconnection</div>
                  </div>
                </h1>
              </div>
              <div className="col-12 col-md-7 col-lg-7">
                <p className="b2b-message-p b2b-pt">
                  ...
                  digital marketing in the Hardware domain.
                  <br />
                  <br />
                  We aim to enhance your online identity through in-depth market
                  analysis and develop personalized digital strategies that
