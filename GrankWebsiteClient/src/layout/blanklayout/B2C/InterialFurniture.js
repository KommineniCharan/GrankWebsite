...
const InterialFurniture = () => {
  ...
  return (
    <>
      <Seo
        title="Digital Marketing Agency for Interiors and Furniture Industries | Bangalore | Hyderabad"
        description="Digital marketing agency for interiors and furniture in bangalore and hyderabad. Explore how we design captivating online experiences, connect with discerning customers, and drive growth in the dynamic world of interior and furniture marketing. "
        name="Company name."
        type="article"
      ...
      <section className="section-top">
        ...
        >
          <img
            ...
            src="assest/photos/b2b/b2b-banner13.png"
            alt="G-Rank"
          />
          <img
            className="img-fluid w-100 desktop-none"
            src="assest/photos/b2b/b2b-banner13-mobile.png"
            alt="G-Rank"
          />
          ...
          <div className="b2b-banner-div">
            ...
            <h4>
              ...
              <br /> Interiors & Furniture Industry
            </h4>
            <motion.h3
              href="#"
              initial={{ opacity: 0, scale: 0 }}
            ...
            <div className="row">
              <div className="col-12 col-md-5 col-lg-5 align-self-center">
                ...
                <h1 className="b2b-message-div">
                  ...
                  <div class="b2b-message">
                    <div class="word1">Elegance</div>
                    <div class="word2">beauty</div>
                    <div class="word3">Sophistication</div>
                  </div>
                </h1>
              </div>
              <div className="col-12 col-md-7 col-lg-7">
                <p className="b2b-message-p  b2b-pt">
                  ...
                  digital marketing in the interior and furniture domain.
                  <br />
                  <br />
                  Our expertise is crafting unique logos and building cohesive
                  brand identities that make businesses rise above the
                  competition.
                </p>
              </div>
            </div>
          ...
          <div className="container-fluid">
            <div>
              <motion.h2
                ...
                transition={{ duration: 0.6 }}
              >
                Interiors & Furniture Digital Marketing Services
              </motion.h2>
              <Slider {...settings3}>
          ...
          <div className="footerimg-div">
            ...
            <div className="footer-div-text">
              <motion.p
                ...
                transition={{ duration: 0.6 }}
              >
                Want to Grow your Interiors
                <br /> & Furniture Business?
              </motion.p>
              <a href="#">
                <motion.p
...
export default InterialFurniture;
