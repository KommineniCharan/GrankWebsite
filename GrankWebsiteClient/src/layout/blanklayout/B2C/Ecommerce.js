...
const Ecommerce = () => {
  ...
  return (
    <>
      <Seo
        title="ECommerce Digital Marketing Agency | Bangalore | Hyderabad"
        description="Ecommerce digital marketing agency in bangalore and hyderabad.   Explore how we optimize online visibility, enhance user experiences, and drive conversions."
        name="Company name."
        type="article"
      ...
      <section className="section-top">
        ...
        >
          <img
            ...
            src="assest/photos/b2b/b2b-banner11.png"
            alt="G-Rank"
          />
          <img
            className="img-fluid w-100 desktop-none"
            src="assest/photos/b2b/b2b-banner11-mobile.png"
            alt="G-Rank"
          />
          ...
          <div className="container">
            <div className="row">
              <div className="col-12 col-md-5 col-lg-5 align-self-center">
                <h2 className="b2b-message-h2  b2b-pt">Bringing</h2>
                <h1 className="b2b-message-div">
                  <span></span>
                  <div class="b2b-message">
                    <div class="word1">Trends</div>
                    <div class="word2">Style</div>
                    <div class="word3">Shifts</div>
                  </div>
                </h1>
                <h2 className="b2b-message-h2">to You</h2>
              </div>
              <div className="col-12 col-md-7 col-lg-7">
                <p className="b2b-message-p  b2b-pt">
                  ...
                  digital marketing in the E-Commerce domain.
                  <br />
                  <br />
                  Our client sees increased visibility, engagement, and revenue
                  through our marketing strategy, data-driven strategies,
                  compelling content, and expert design.
                </p>
              </div>
            </div>
          </div>
