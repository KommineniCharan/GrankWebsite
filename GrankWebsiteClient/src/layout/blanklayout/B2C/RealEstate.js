...
const RealEstate = () => {
  ...
  return (
    <>
      <Seo
        title="Real Estate Digital Marketing Agency | Hyderabad | Bangalore "
        description="Real estate digital marketing agency in bangalore and hyderabad. Elevate your real estate brand with expert Digital Marketing solutions. Explore how we transform online presence, drive leads, and connect with buyers and sellers"
        name="Company name."
        type="article"
      ...
      <section className="section-top">
        ...
        >
          <img
            ...
            src="assest/photos/b2b/b2b-banner9.png"
            alt="G-Rank"
          />
          <img
            className="img-fluid w-100 desktop-none"
            src="assest/photos/b2b/b2b-banner9-mobile.png"
            alt="G-Rank"
          />
            ...
            <div className="row">
              <div className="col-12 col-md-5 col-lg-5 align-self-center">
                ...
                <h1 className="b2b-message-div">
                  ...
                  <div class="b2b-message">
                    <div class="word1">future</div>
                    <div class="word2">Living</div>
                    <div class="word3">Lifestyle</div>
                  </div>
                </h1>
              </div>
              <div className="col-12 col-md-7 col-lg-7">
                <p className="b2b-message-p  b2b-pt">
                  ...
                  digital marketing in the real estate domain.
                  <br />
                  <br />
                  We aim to tailor the marketing process to meet the genuine
                  needs of our valuable real estate clients.
                </p>
              </div>
            </div>
          </div>
