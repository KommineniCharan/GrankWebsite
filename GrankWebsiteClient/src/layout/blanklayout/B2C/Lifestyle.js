...
const Lifestyle = () => {
  ...
  return (
    <>
      <Seo
        title="Digital Marketing Agency for Lifestyle | Bangalore | Hyderabad"
        description="Digital marketing agency for lifestyle brands in bangalore and hyderbad.  Explore how we enrich online presence, connect with your target audience, and amplify growth in the dynamic world of lifestyle marketing. "
        name="Company name."
        type="article"
      ...
      <section className="section-top">
        ...
        >
          <img
            ...
            src="assest/photos/b2b/b2b-banner12.png"
            alt="G-Rank"
          />
          <img
            className="img-fluid w-100 desktop-none"
            src="assest/photos/b2b/b2b-banner12-mobile.png"
            alt="G-Rank"
          />
          ...
          <div className="container">
            <div className="row">
              <div className="col-12 col-md-5 col-lg-5 align-self-center">
                <h2 className="b2b-message-h2  b2b-pt">Where </h2>
                <h1 className="b2b-message-div">
                  <span></span>
                  <div class="b2b-message">
                    <div class="word1">Dream</div>
                    <div class="word2">Vision</div>
                    <div class="word3">passion</div>
                  </div>
                </h1>
                <h2 className="b2b-message-h2">Take Flight</h2>
              </div>
              <div className="col-12 col-md-7 col-lg-7">
                <p className="b2b-message-p  b2b-pt">
                  ...
                  digital marketing in the Lifestyle domain.
                  <br />
                  <br />
                  We analyze the market to improve your online identity and
                  create custom digital strategies aligned with brand values,
                  target audience preferences, and industry trends.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container-fluid">
            <div>
              <motion.h2
                ...
                transition={{ duration: 0.6 }}
              >
                Lifestyle Digital Marketing Services
              </motion.h2>
              <Slider {...settings3}>
